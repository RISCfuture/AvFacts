...
RSpec.describe TranscodingController, type: :controller do
  ...
  describe '#show' do
    ...
    it "should redirect to the service URL for a transcoded file" do
      ...
      expect(response).to redirect_to(/http:\/\/test\.host\/rails\/active_storage\/disk\/.+\/audio\.mp3\?content_type=audio%2Fmp3&disposition=inline%3B\+filename%3D%22audio\.mp3%22%3B\+filename%2A%3DUTF-8%27%27audio\.mp3$/)
    end
